...
<p align="center"><a href="https://github.com/ChenYilong/iOSPracticeQuestions/blob/master/02_swift_topic_notes/theory.md"><img src="../assets/swift_practical_topics.jpg"></a></p>
...
非常好的 MVVM 的开源项目, 可以参考下: https://github.com/kickstarter/ios-oss
...
iOS 讨论问题： 你能解释一下基于令牌的身份验证是如何工作的吗？如何在这种身份验证中，从应用程序接口获取一个令牌，并在随后的应用程序接口调用中使用它?
